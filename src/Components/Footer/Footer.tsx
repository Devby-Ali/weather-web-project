...
const Footer = (): React.JSX.Element => {
  return (
    <div className="absolute bottom-0 flex px-6 items-center justify-between w-full h-[106px] bg-gradient-to-r dark:from-[#292F45] dark:via-[#3F4861] dark:to-[#151D32] from-[#F3FAFE] via-[#CCDDDD9E] to-[#F3FAFE] text-darkText dark:text-lightText">
